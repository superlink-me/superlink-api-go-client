...
*/
func (a *DefaultAPIService) CreateAccessToken(ctx context.Context) ApiCreateAccessTokenRequest {
	return ApiCreateAccessTokenRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DefaultAPIService) CreateAccessTokenExecute(r ApiCreateAccessTokenRequest) (*ApiAccessTokenResponse, *http.Response, error) {
	var (
...
*/
func (a *DefaultAPIService) ListAccessTokens(ctx context.Context) ApiListAccessTokensRequest {
	return ApiListAccessTokensRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ApiAccessTokenResponse
func (a *DefaultAPIService) ListAccessTokensExecute(r ApiListAccessTokensRequest) (*ApiAccessTokenResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *DefaultAPIService) ResolveDataByDomain(ctx context.Context, domain string) ApiResolveDataByDomainRequest {
	return ApiResolveDataByDomainRequest{
		ApiService: a,
		ctx: ctx,
		domain: domain,
...
func (a *DefaultAPIService) ResolveDataByDomainExecute(r ApiResolveDataByDomainRequest) (*ApiResolveDomainResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.ResolveDataByDomain")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
