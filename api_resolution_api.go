...
// ResolutionApiAPIService ResolutionApiAPI service
type ResolutionApiAPIService service

type ApiResolveDataByDomainRequest struct {
	ctx context.Context
	ApiService *ResolutionApiAPIService
	domain string
}
...
/*
ResolveDataByDomain Resolves wallets and records given a domain
...
*/
func (a *ResolutionApiAPIService) ResolveDataByDomain(ctx context.Context, domain string) ApiResolveDataByDomainRequest {
	return ApiResolveDataByDomainRequest{
		ApiService: a,
		ctx: ctx,
		domain: domain,
...
func (a *ResolutionApiAPIService) ResolveDataByDomainExecute(r ApiResolveDataByDomainRequest) (*ApiResolveWalletAddressByDomainResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ResolutionApiAPIService.ResolveDataByDomain")
	if err != nil {
