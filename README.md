...
------------ | ------------- | ------------- | -------------
*DefaultAPI* | [**CreateAccessToken**](docs/DefaultAPI.md#createaccesstoken) | **Post** /v1/access-token | Creates an admin token
*DefaultAPI* | [**DeleteAccessToken**](docs/DefaultAPI.md#deleteaccesstoken) | **Delete** /v1/access-token | Deletes an access token
*DefaultAPI* | [**HealthCheck**](docs/DefaultAPI.md#healthcheck) | **Get** /v1/health | Checks the health of the API
*DefaultAPI* | [**ListAccessTokens**](docs/DefaultAPI.md#listaccesstokens) | **Get** /v1/access-token | Lists access tokens
*DefaultAPI* | [**ResolveDataByDomain**](docs/DefaultAPI.md#resolvedatabydomain) | **Get** /v1/resolve/{domain} | Resolves wallets and DNS records for a domain
