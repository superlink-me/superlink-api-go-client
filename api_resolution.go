...
/*
RemoveReverseResolutionAddress Assigns a reverse resolution address from a domain
...
*/
func (a *ResolutionAPIService) RemoveReverseResolutionAddress(ctx context.Context) ApiRemoveReverseResolutionAddressRequest {
	return ApiRemoveReverseResolutionAddressRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ResolutionAPIService) RemoveReverseResolutionAddressExecute(r ApiRemoveReverseResolutionAddressRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ResolutionAPIService.RemoveReverseResolutionAddress")
	if err != nil {
...
*/
func (a *ResolutionAPIService) SetReverseResolutionAddress(ctx context.Context) ApiSetReverseResolutionAddressRequest {
	return ApiSetReverseResolutionAddressRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *ResolutionAPIService) SetReverseResolutionAddressExecute(r ApiSetReverseResolutionAddressRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ResolutionAPIService.SetReverseResolutionAddress")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
